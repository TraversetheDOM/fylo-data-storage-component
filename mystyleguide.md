...
/* opera 11.10+ */
background: -o-linear-gradient(90deg, var(--carrot) 0%, var(--soft-pink) 100%);

/* ie 6-9 */
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#FF4D97', endColorstr='#FFA399', GradientType=0 );

/* ie 10+ */
background: -ms-linear-gradient(90deg, var(--carrot) 0%, var(--soft-pink) 100%);

/* global 94%+ browsers support */
background: linear-gradient(90deg, var(--carrot) 0%, var(--soft-pink) 100%);
```
